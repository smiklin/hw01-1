...
<center> \[ \text{log-odds('Done last minute')} \sim \text{enjoyable_task} + \text{n_other_tasks} + \text{deadline_worry} \] </center>
...
The model would then be:
<center> \[\text{log-odds('Procrasinator')} \sim \text{anxiety}^2 - \text{perfectionism} + \text{work_quickly} \] </center>
